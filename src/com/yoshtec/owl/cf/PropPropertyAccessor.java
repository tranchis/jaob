...
public class PropPropertyAccessor implements PropertyAccessor{
    ...
    public PropPropertyAccessor(Method getter, Method setter, URI propUri, XsdTypeMapper typeMapper) {
        this.init(getter, setter, propUri, null, typeMapper);
    }

    public PropPropertyAccessor(Method getter, Method setter, URI propUri, XmlAdapter<?, ?> adapter, XsdTypeMapper typeMapper) {
